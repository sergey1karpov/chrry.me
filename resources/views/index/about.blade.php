...
<body class="relative">
        ...
        <div class="mx-auto max-w-[43rem]">
            <div class="text-start">
                ...
                <h1 class="mt-3 ml-5 mr-5 text-[48px] font-bold leading-[4rem] tracking-tight text-white"
                    ...
                    {{ __('main.about_us') }}</h1>
                <h2 class="mt-6 ml-5 mr-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    {{ __('main.about_us_descr') }}
                </h2>
            </div>
        </div>
    </div>
    ...
    <div class="py-24 flex items-center min-h-screen justify-center bg-red-300">
        <div class="mx-auto max-w-[43rem]">
            <div class="text-start">
                <h2 class="flex justify-center mt-16 ml-5 mr-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <img class="h-auto max-w-full rounded-lg" src="{{ asset('public/images/photos/kirillll.jpg') }}"
                        alt="image description">
                </h2>
                <h2 class="mt-3 ml-5 mr-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <span class="text-blue-600 dark:text-blue-500">{{ __('main.about_kirill') }}</span>
                </h2>
                <h2 class="mt-3 ml-5 mr-5 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    {{ __('main.about_kirill_1') }}
                </h2>
                <p class="mt-3 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <strong class="font-semibold text-gray-900 dark:text-white">
                        {{ __('main.about_kirill_2') }}
                    </strong>
                </p>
                <p class="mt-1 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <strong class="font-semibold text-gray-900 dark:text-white">
                        {{ __('main.about_kirill_3') }}
                    </strong>
                </p>
                <p class="mt-1 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <strong class="font-semibold text-gray-900 dark:text-white">
                        {{ __('main.about_kirill_4') }}
                    </strong>
                </p>
                <p class="mt-1 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <strong class="font-semibold text-gray-900 dark:text-white">
                        {{ __('main.about_kirill_5') }} <a class="underline"
                            href="https://www.youtube.com/watch?v=HCpO1mRlf4U">{{ __('main.about_kirill_6') }}</a>,
                        {{ __('main.about_kirill_7') }}
                    </strong>
                </p>
                <p class="mt-1 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <a href="https://www.instagram.com/kirill_lashtanov/"
                        class="inline-flex items-center justify-center text-base font-medium text-gray-500 rounded-lg">
                        <img class="rounded-lg mr-4" src="{{ asset('public/images/auth_icons/inst.jpg') }}"
                            width="20">
                        <span class="w-full">Instagram</span>
                    </a>
                </p>
                <p class="ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <a href="https://vk.com/averro"
                        class="inline-flex items-center justify-center text-base font-medium text-gray-500 rounded-lg">
                        <img class="rounded-lg mr-4" src="{{ asset('public/images/auth_icons/vk.jpg') }}"
                            width="20">
    ...
    <div class="py-24 flex items-center min-h-screen justify-center bg-purple-300">
        <div class="mx-auto max-w-[43rem]">
            <div class="text-start">
                <h2 class="flex justify-center mt-16 ml-5 mr-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <img class="h-auto max-w-full rounded-lg" src="{{ asset('public/images/photos/sergey.jpg') }}"
                        alt="image description">
                </h2>
                <h2 class="mt-3 ml-5 mr-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <span class="text-blue-600 dark:text-blue-500">{{ __('main.about_sergey') }}</span>
                </h2>
                <h2 class="mt-3 ml-5 mr-5 text-2xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    {{ __('main.about_sergey_1') }}
                </h2>
                <p class="mt-3 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <strong class="font-semibold text-gray-900 dark:text-white">
                        {{ __('main.about_sergey_2') }}
                    </strong>
                </p>
                <p class="mt-1 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <strong class="font-semibold text-gray-900 dark:text-white">
                        {{ __('main.about_sergey_3') }}
                    </strong>
                </p>
                <p class="mt-1 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <strong class="font-semibold text-gray-900 dark:text-white">
                        {{ __('main.about_sergey_4') }}
                    </strong>
                </p>
                <p class="mt-1 ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <a href="https://www.instagram.com/sergey1karpov/"
                        class="inline-flex items-center justify-center text-base font-medium text-gray-500 rounded-lg">
                        <img class="rounded-lg mr-4" src="{{ asset('public/images/auth_icons/inst.jpg') }}"
                            width="20">
                        <span class="w-full">Instagram</span>
                ...
                <p class="ml-5 mr-5 mb-3 font-light text-gray-500 dark:text-gray-400"
                    style="line-height: 1.05; letter-spacing: -0.04em;">
                    <a href="https://vk.com/kkkkkarpov"
                        class="inline-flex items-center justify-center text-base font-medium text-gray-500 rounded-lg">
                        <img class="rounded-lg mr-4" src="{{ asset('public/images/auth_icons/vk.jpg') }}"
                            width="20">
                        <span class="w-full">VK</span>
