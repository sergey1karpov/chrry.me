...
<div class="py-24 flex items-center min-h-screen justify-center bg-orange-300">
    <div class="mx-auto max-w-[43rem]">
        <div class="text-start">
            ...
            <h1 class="mt-3 ml-5 mr-5 text-[48px] font-bold leading-[4rem] tracking-tight text-white" style="line-height: 1.05; letter-spacing: -0.02em; font-family: 'Open Sans', sans-serif;">Если вы находитесь на этой странице, значит вы хотите с нами связяться</h1>
            <h2 class="mt-6 ml-5 mr-5 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white" style="line-height: 1.05; letter-spacing: -0.04em;">Попробуйте написать нам на почту, может быть ответим <span class="text-blue-600 dark:text-blue-500">support@chrry.me</span></h2>
