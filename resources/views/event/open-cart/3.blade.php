<div class="relative rounded-lg" style="" data-clickAway="true">
    <div href="#" id="block-4-img" class="relative block overflow-hidden rounded-t-xl bg-[url({{'/'.$event->banner}})] bg-cover bg-center bg-no-repeat">
        <div class="relative  p-2 pt-64 text-white">
            @if(Request::route()->getName() != 'editAllEventsForm')
    ...
    <div class="bg-[{{$properties->de_oc_bg_color}}] flex justify-between pl-2 pr-2" id="pos-3-1">
    ...
    <div class="bg-[{{$properties->de_oc_bg_color}}] flex flex-wrap {{$properties->de_oc_text_position}} pl-2 pr-2" id="pos-3-2">
    ...
    <div class="bg-[{{$properties->de_oc_bg_color}}] flex flex-wrap {{$properties->de_oc_text_position}} pl-2 pr-2 pb-2" id="pos-3-3">
