<div class="relative rounded-lg" data-clickAway="true">
    <div href="#" id="block-4-img" class="relative block overflow-hidden rounded-t-xl bg-[url({{'/'.$event->banner}})] bg-cover bg-center bg-no-repeat">
        <div class="relative p-2 pt-64">
            ...
            @endif
            <div class="flex flex-wrap {{$properties->de_oc_text_position}}" id="pos-1-1">
                <h2 id="city-field" class="" style="
            ...
            <div class="flex flex-wrap {{$properties->de_oc_text_position}}" id="pos-1-2">
            ...
            <div class="flex flex-wrap {{$properties->de_oc_text_position}}" id="pos-1-3">
                ...
                <h2 id="time-field" class="" style="
                    ...
                    padding: 0;
                    color: {{$properties->de_oc_time_font_color}}">{{$event->time}}
                </h2>
            </div>
        </div>
    </div>
    ...
    @if($event->description)
        <div class="bg-[{{$properties->de_oc_bg_color}}] {{$properties->de_oc_description_position}} p-2" id="descr-position">
            <h2 id="description-field" style="
    ...
    @endif
    @if($event->video)
        <div id="video-block" class="embed-responsive embed-responsive-16by9 mt-2 ">
            <x-embed url="{{$event->video}}" aspect-ratio="4:3" />
        </div>
    @endif
    @if($event->btn_text)
        <div>
            <button id="ticket-link-text-field" type="button" class="w-full bg-[{{$properties->de_oc_btn_color}}] rounded-b-lg px-5 py-2.5">
                <h2 style="
