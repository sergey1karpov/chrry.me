                ...
                ">
                    <div class="row text-center">
                        <div class="col-12 text-center mt-3 mb-3" style="padding: 0">
                            <div id="card-1-position-1" class="@if($properties->de_text_position == 'justify-start') ml-2 @endif @if($properties->de_text_position == 'justify-end') mr-2 @endif flex flex-wrap {{$properties->de_text_position}}">
                                ...
                                <h2 class="" id="open-location-field" style="
                            ...
                            <div id="card-1-position-2" class="@if($properties->de_text_position == 'justify-start') ml-2 @endif @if($properties->de_text_position == 'justify-end') mr-2 @endif flex flex-wrap {{$properties->de_text_position}}">
                                <h2 class="" id="open-date-field" style="
                                ...
                                @if($properties->de_show_card_time == 1)
                                    <h2 class="ml-2" id="open-time-field" style="
