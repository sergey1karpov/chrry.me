<div class="col-lg-12 allalbums">
    <ul class="list-group list-group-flush">
        <li class="{{$properties->de_border}} list-group-item list-group-item-action text-center pt-2 pb-2" style="border-color: {{$properties->de_border_color}}; background-color: rgba({{$properties->de_background_color_rgba}}, {{$properties->de_transparency}}); border-radius: {{$properties->de_event_round}}px; border-color: {{$properties->de_border_color}}">
