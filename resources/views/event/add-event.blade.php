                                    ...
                                    <form action="{{ route('addEvent', ['user' => Auth::user()->id]) }}" method="post" enctype="multipart/form-data"> @csrf @method('POST')
                                        ...
                                        <div class="mb-8 w-full mx-auto max-w-screen-xl px-4 shadow-lg @if($user->dayVsNight == 1) bg-black @endif">
                                            <div class="mb-6 text-center">
                                                ...
                                                <select onchange="city()" style="border: none" name="city_id" id="select-city" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded block w-full @if($user->dayVsNight == 1) bg-gray-900 dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 " data-placeholder="Начните вводить название..."  autocomplete="off"></select>
                                            </div>
                                            <div class="mb-6 text-center">
                                                ...
                                                <input required name="location" placeholder="1 OAK Tokyo" maxlength="100" id="location" style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-gray-900 dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                                            </div>
                                            <div class="mb-6 text-center">
                                                ...
                                                <div class="relative mt-1">
                                                    ...
                                                    <input id="datepicker" name="date" type="date" style="border: none" class="bg-gray-50 text-gray-900 text-sm rounded-lg block w-full pl-10 p-2.5 @if($user->dayVsNight == 1) bg-gray-900 dark:text-gray-400 @endif dark:placeholder-gray-400 dark:text-white" placeholder="Select date">
                                                </div>
                                            </div>
                                            <div class="mb-6 text-center">
                                                ...
                                                <input required name="time" placeholder="21:00" maxlength="100" id="time" style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-gray-900 dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                                            </div>
                                            <div class="mb-6 text-center">
                                                ...
                                                <input required name="banner" accept=".jpg, .jpeg, .png, .gif" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full @if($user->dayVsNight == 1) bg-gray-900 dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400" aria-describedby="avatar" id="avatar" type="file">
                                                <p class="mt-1 text-sm @if($user->dayVsNight == 1) text-gray-500 @else text-gray-500 @endif" id="avatar">{{ __('main.event_banner_descr') }}</p>
                                            </div>

                                            <div class="mb-2 mt-4 text-center rounded-lg bg-blue-700 p-2">
                                                <label class="relative inline-flex items-center cursor-pointer">
                                                    <input name="send_email" id="send_email" value="{{true}}" type="checkbox" class="sr-only peer">
                                                    ...
                                                    <span class="ml-3 mt-1 text-sm font-medium leading-relaxed text-indigo-600"><mark class="px-2 text-white bg-purple-500 rounded dark:bg-purple-500">Email рассылка</mark></span>
                                                </label>
                                                <p class="mt-2 mb-6 text-sm font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Отправить email уведомление о предстоящем мероприятии всем подписчикам из выбранного города, если они у вас есть</p>
{{--                                                <div class="inline-flex rounded-md shadow-sm" role="group">--}}
{{--                                                    <a href="{{ route('createMailForm', ['user' => $user->id]) }}" type="button" class="px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-l-lg hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">--}}
{{--                                                        Написать письмо--}}
{{--                                                    </a>--}}
{{--                                                    <a type="button" class="px-4 py-2 text-sm font-medium text-gray-900 bg-transparent border border-gray-900 rounded-r-md hover:bg-gray-900 hover:text-white focus:z-10 focus:ring-2 focus:ring-gray-500 focus:bg-gray-900 focus:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:bg-gray-700">--}}
{{--                                                        Редактировать--}}
{{--                                                    </a>--}}
{{--                                                </div>--}}
                                            </div>
                                            ...
                                            <div class="mb-6 text-center">
                                                ...
                                                <input required name="title" placeholder="Title for event card" maxlength="255" id="title" style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-gray-900 dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                                            </div>
                                            <div class="mb-6 text-center">
                                                ...
                                                <input required name="tickets" id="ticket_link" placeholder="Link to sell tickets"  style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-gray-900 dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                                            </div>
                                            <div class="mb-6 text-center">
                                                ...
                                                <input required name="btn_text" id="ticket_link_text" placeholder="Title for event button" maxlength="50"  style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-gray-900 dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                                            </div>
                                            <div class="mb-6 text-center">
                                        ...
                                        @if(count($user->events) != 0)
                                            <div class="mt-20 text-center rounded-lg p-5 ">
                                                <label class="relative inline-flex items-center cursor-pointer">
...
{{--                                <div class="mb-3 w-full mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8" id="bg-block" style="">--}}
...
{{--                                                            <div class="flex flex-wrap justify-center" id="card-1-position-1">--}}
{{--                                                                <h2 class="mr-2" id="open-city-field" style="">--}}
{{--                                                                    City--}}
{{--                                                                </h2>--}}
{{--                                                                <h2 id="open-location-field" class="">--}}
{{--                                                                    Location--}}
{{--                                                                </h2>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="flex flex-wrap justify-center" id="card-1-position-2">--}}
{{--                                                                <h2 class="" id="open-date-field">--}}
{{--                                                                    Date--}}
{{--                                                                </h2>--}}
{{--                                                                <h2 class="ml-2" id="open-time-field">--}}
{{--                                                                    Time--}}
{{--                                                                </h2>--}}
{{--                                                            </div>--}}
{{--                                                        </div>--}}
...
{{--                                                    <div class="row text-center">--}}
{{--                                                        <div class="col-12 text-center mt-3 mb-3" style="padding: 0">--}}
{{--                                                            <div class="flex flex-wrap justify-center" id="card-2-position-1">--}}
{{--                                                                <h2 class="" id="open-city-field" style="">--}}
{{--                                                                    City--}}
{{--                                                                </h2>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="flex flex-wrap justify-center" id="card-2-position-2">--}}
{{--                                                                <h2 id="open-location-field" class="">--}}
{{--                                                                    Location--}}
{{--                                                                </h2>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="flex flex-wrap justify-center" id="card-2-position-3">--}}
{{--                                                                <h2 class="" id="open-date-field">--}}
{{--                                                                    Date--}}
{{--                                                                </h2>--}}
{{--                                                                <h2 class="ml-2" id="open-time-field">--}}
...
{{--                                <div class="container mt-2">--}}
{{--                                    <div class="col-lg-12 allalbums">--}}
{{--                                        <ul class="list-group list-group-flush" id="anim-3">--}}
{{--                                            <li class="list-group-item list-group-item-action text-center">--}}
{{--                                                <div href="#" id="block-3-img" class="relative block overflow-hidden bg-cover bg-center bg-no-repeat">--}}
{{--                                                    <div class="relative bg-black bg-opacity-40 p-8 pt-32">--}}
{{--                                                        <div class="flex flex-wrap justify-center" id="card-3-position-1">--}}
{{--                                                            <h2 class="mr-2" id="open-city-field" style="">--}}
{{--                                                                City--}}
{{--                                                            </h2>--}}
{{--                                                            <h2 id="open-location-field" class="">--}}
...
{{--                                                            </h2>--}}
{{--                                                        </div>--}}
{{--                                                        <div class="flex flex-wrap justify-center" id="card-3-position-2">--}}
{{--                                                            <h2 class="" id="open-date-field">--}}
{{--                                                                Date--}}
{{--                                                            </h2>--}}
{{--                                                            <h2 class="ml-2" id="open-time-field">--}}
...
{{--                                <div class="m-3 w-full mx-auto max-w-screen-xl">--}}
{{--                                    <div class="container mt-2">--}}
{{--                                        <div class="col-lg-12 allalbums">--}}
{{--                                            <ul class="list-group list-group-flush" id="anim-3">--}}
{{--                                                <li class="list-group-item list-group-item-action text-center">--}}
{{--                                                    <article class="overflow-hidden transition " id="bg-round-card" style="">--}}
{{--                                                        <img alt="Office" src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/ItchyPoopzkidDeichbrand2015.jpg/1200px-ItchyPoopzkidDeichbrand2015.jpg" id="avatar-user" class="h-32 w-full object-cover"/>--}}
{{--                                                        <div class="p-4 sm:p-6" id="bg-block" style="">--}}
{{--                                                            <div class="flex flex-wrap justify-center" id="card-4-position-1">--}}
{{--                                                                <h2 class="" id="open-date-field">--}}
{{--                                                                    Date--}}
{{--                                                                </h2>--}}
{{--                                                                <h2 class="ml-2" id="open-time-field">--}}
...
{{--                                                                </h2>--}}
{{--                                                            </div>--}}
{{--                                                            <div class="flex flex-wrap justify-center" id="card-4-position-2">--}}
{{--                                                                <h2 class="mr-1" id="open-city-field" style="">--}}
{{--                                                                    City--}}
{{--                                                                </h2>--}}
{{--                                                                <h2 id="open-location-field" class="">--}}
{{--                                                                    Location--}}
...
{{--                                    <div class="col-lg-12 allalbums">--}}
{{--                                        <ul class="list-group list-group-flush">--}}
{{--                                            <li class="list-group-item list-group-item-action iii">--}}
{{--                                                <div href="#" id="block-4-img" class="relative block overflow-hidden rounded-t-xl bg-cover bg-center bg-no-repeat">--}}
{{--                                                    <div class="relative bg-black bg-opacity-40 p-2 pt-44">--}}
{{--                                                        <div class="flex flex-wrap justify-center" id="pos-1-1">--}}
{{--                                                            <h2 class="" id="city-field">--}}
{{--                                                                City--}}
{{--                                                            </h2>--}}
{{--                                                        </div>--}}
{{--                                                        <div class="flex flex-wrap justify-center" id="pos-1-2">--}}
{{--                                                            <h2 class="" id="location-field">--}}
{{--                                                                Location--}}
{{--                                                            </h2>--}}
{{--                                                        </div>--}}
{{--                                                        <div class="flex flex-wrap justify-center" id="pos-1-3">--}}
{{--                                                            <h2 class="" id="date-field">--}}
{{--                                                                Date--}}
{{--                                                            </h2>--}}
{{--                                                            <h2 class="ml-2" id="time-field">--}}
{{--                                                                Time--}}
{{--                                                            </h2>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <div class="text-center p-2" id="title-position">--}}
{{--                                                    <h2 class="" id="title-field">Title</h2>--}}
{{--                                                </div>--}}
{{--                                                <div class="text-center p-2" id="descr-position">--}}
{{--                                                    <h2 style="white-space: pre-wrap;" class="" id="description-field">Description</h2>--}}
{{--                                                </div>--}}
{{--                                                <div class="embed-responsive embed-responsive-16by9" id="video-block">--}}

{{--                                                </div>--}}
{{--                                                <div>--}}
{{--                                                    <button type="button" class="w-full rounded-b-lg px-5 py-2.5" id="ticket-link-text-field">Ticket</button>--}}
{{--                                                </div>--}}
{{--                                            </li>--}}
{{--                                        </ul>--}}
{{--                                    </div>--}}
...
{{--                                                    <h2 class="" id="title-field">Title</h2>--}}
{{--                                                </div>--}}
{{--                                                <div class="flex flex-wrap justify-center pl-2 pr-2" id="pos-2-1">--}}
{{--                                                    <h2 class="mr-2" id="city-field">City</h2>--}}
{{--                                                    <h2 class="" id="location-field">Location</h2>--}}
{{--                                                </div>--}}
{{--                                                <div class="flex justify-center pl-2 pr-2" id="pos-2-2">--}}
{{--                                                    <h2 class="mr-2" id="date-field">--}}
{{--                                                        Date--}}
{{--                                                    </h2>--}}
{{--                                                    <h2 class="" id="time-field">--}}
{{--                                                        Time--}}
{{--                                                    </h2>--}}
{{--                                                </div>--}}
{{--                                                <div class="text-center p-2" id="descr-position">--}}
...
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <div class="flex justify-between pl-2 pr-2" id="pos-3-1">--}}
{{--                                                    <h2 class="mr-2" id="date-field">--}}
{{--                                                        Date--}}
{{--                                                    </h2>--}}
{{--                                                    <h2 class="" id="time-field">--}}
...
{{--                                                    </h2>--}}
{{--                                                </div>--}}
{{--                                                <div class="flex flex-wrap justify-center pl-2 pr-2" id="pos-3-2">--}}
{{--                                                    <h2 class="" id="city-field">City</h2>--}}
{{--                                                </div>--}}
{{--                                                <div class="flex flex-wrap justify-center pl-2 pr-2" id="pos-3-3">--}}
{{--                                                    <h2 class="" id="location-field">Location</h2>--}}
{{--                                                </div>--}}
{{--                                                <div class="text-center p-2" id="descr-position">--}}
{{--                                                    <h2 style="white-space: pre-wrap;" class="" id="description-field">Description</h2>--}}
