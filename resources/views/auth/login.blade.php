            ...
            <form method="POST" action="{{ route('login') }}" class="text-center" id="login-form"> @csrf
                ...
                <div class="block mt-5">
                    <label for="remember_me" class="inline-flex items-center">
                        <input name="remember" id="remember_me" type="checkbox" value="" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800">
                        <span class="ml-2 block text-sm font-medium text-gray-900 text-dark" >{{ __('Remember me') }}</span>
                    </label>
                </div>
