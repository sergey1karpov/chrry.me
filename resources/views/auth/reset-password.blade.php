                    ...
                    <x-guest-layout>
                        <x-auth-card>
                            ...
                            <div class="mb-4 mt-4 text-sm text-gray-600 text-center" style="font-family: 'Overpass Mono', monospace;">
                                <h1 class="display" style="font-size:1.1rem; font-family: 'Rubik', sans-serif;">Для восстановления пароля введите свой email, и мы отправим вам на почту инструкцию что делать дальше</h1>
                            </div>
                            ...
                            <form method="POST" action="{{ route('password.update') }}" class="text-center">
                                ...
                                <!-- Password -->
                                <div class="mt-4">
                                    <x-label for="password" :value="__('Password')" style="font-family: 'Rubik', sans-serif;"/>

                                    <x-input style="border-radius: 0px; border-top: 0; border-left: 0; border-right: 0;" id="password" class="form-control" type="password" name="password" required />
                                </div>

                                <!-- Confirm Password -->
                                <div class="mt-4">
                                    <x-label for="password_confirmation" :value="__('Confirm Password')" style="font-family: 'Rubik', sans-serif;"/>

                                    <x-input style="border-radius: 0px; border-top: 0; border-left: 0; border-right: 0;" id="password_confirmation" class="form-control"
                                                        type="password"
