...
{{--                </div>--}}
        ...
        <div class="py-24 flex items-center min-h-screen justify-center bg-orange-300">
            <div class="mx-auto max-w-[43rem]">
                ...
                <div class="mt-6 ml-5 flex items-center justify-start gap-4">
                    <a class="inline-block text-xl rounded-full bg-red-500 px-8 py-3 text-sm font-bold text-white transition hover:scale-110 hover:shadow-xl focus:outline-none focus:ring active:bg-red-500" href="{{ route('register') }}">
                        Регистрация
                    </a>
                </div>
            </div>
        ...
        <div class="bg-cover bg-center flex flex-col w-full overflow-x-hidden bg-[url('https://www.wallpapertip.com/wmimgs/5-55770_iphone-x-wallpaper-sea.jpg')]">
            <div class="mx-auto max-w-[43rem]">
                <div class="text-start">
                    <h1 class="mt-20 ml-5 mr-5 text-[2.5rem] font-bold leading-[4rem] tracking-tight text-white" style="line-height: 1.05; letter-spacing: -0.02em; font-family: 'Open Sans', sans-serif;">Ссылки</h1>
                    <p class="mt-6 ml-5 mr-5 text-lg font-medium leading-relaxed opacity-85 text-white" style="line-height: 1.05; letter-spacing: -0.04em;">Вы можете добавить более 50 ссылок. В качестве изображения загружайте обычные картинки, гифки или иконки из нашей коллекции. Широкие возможности кастомизации ссылок. Отслеживайте каждый уникальный клик</p>
                </div>
                            ...
                            <div class="relative overflow-hidden rounded-lg md:h-96" style="height: 17rem">
                                <div class="hidden duration-700 ease-in-out" data-carousel-item>
                                    <div class="flex justify-center">
                                        <p class="mb-5 text-left text-white dark:text-white font-semibold ">Используйте аватар</p>
                                    </div>
                                    <div class="flex justify-center">
                                        <img src="https://media4.giphy.com/media/v1.Y2lkPTc5MGI3NjExYmZkOTcwYzVmODI1ZjdlYWI3YzM4N2I1NmU4ZmQzMGViNjJiNTdhNiZjdD1n/mDSGaOdQxzdseSPdAi/giphy.gif" class="w-40 rounded-full mt-3 shadow-lg">
                                    </div>
                                    <p class="mt-6 flex justify-center items-center text-3xl font-bold text-gray-900  shadow-lg" style="color: #F26666; text-shadow: 2px 2px 1px black">
                                        Bean
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="ml-3 mt-2 bi bi-patch-check-fill" viewBox="0 0 16 16" style="color: #305BD2;">
                                ...
                                <div class="hidden duration-700 ease-in-out " data-carousel-item>
                                    <div class="flex justify-center">
                                        <p class="mb-5 text-left text-white dark:text-white font-semibold">или Логотип</p>
                                    </div>
                                    <div class="flex justify-center">
                                        <img src="https://www.pngarts.com/files/13/Chupa-Chups-Logo-PNG-Transparent-Image.png" width="240">
                                    </div>
                                </div>
                            </div>
                                ...
                                <td>
                                    <div class="justify-center text-center" data-index="" data-position="">
                                        <form method="POST" action="">
                                            <div class="animate__animated animate__pulse animate__infinite infinite border-2 border-black row card ms-1 me-1" style="
                                                ...
                                                <div class="flex align-center justify-between" style="padding-left: 4px; padding-right: 4px">
                                                    ...
                                                    <button type="submit" style="border: 0; padding: 0; background-color: rgba(0, 125, 215, 0);">
                                                        <div class="col-span-10 text-center flex items-center">
                                                            <div class="ml-3 mr-3">
                                                                <h4 class="drop-shadow-md text-xl font-extrabold text-ellipsis text-[#00AFF0]" style="margin: 0 0 0 10px; font-family: 'Lexend', sans-serif; font-size: 20px; text-shadow: 0px 2px 1px black;">OnlyFans</h4>
                                                            </div>
                                                        </div>
                                                    </button>
                        ...
                        <table class="table w-full">
                            ...
                            <tr data-index="" data-position="">
                                <td>
                                    <div class="justify-center text-center" data-index="" data-position="">
                                        <form method="POST" action="">
                                            <div class="shadow-lg border-black row card ms-1 me-1 border-2" style="
                                                animation-duration: 2s;
                                            ...
                                            ">
                                                <div class="flex align-center justify-between" style="padding-left: 4px; padding-right: 4px">
                                                    ...
                                                    <button type="submit" style="border: 0; padding: 0; background-color: rgba(0, 125, 215, 0);">
                                                        <div class="col-span-10 text-center flex items-center">
                                                            <div class="ml-3 mr-3">
                                                                <h4 class="drop-shadow-md text-xl font-extrabold text-ellipsis text-white" style="margin: 0 0 0 10px; font-family: 'Lexend', sans-serif; font-size: 17px; text-shadow: 1px 4px 0px black;">My YouTube channel</h4>
                                                            </div>
                                                        </div>
                                                    </button>
                                                    <div class="col-span-1 flex items-center flex-none" style="opacity: 0">
                        ...
                        <table class="table w-full">
                            ...
                            <tr data-index="" data-position="">
                                <td>
                                    <div class="justify-center text-center" data-index="" data-position="">
                                        <form method="POST" action="">
                                            <div class="border-2 shadow-lg border-white row card ms-1 me-1" style="
                                                animation-duration: 2s;
                                            ...
                                            ">
                                                <div class="flex align-center justify-between" style="padding-left: 4px; padding-right: 4px">
                                                    <div class="col-span-1 flex items-center flex-none">
                                                        <img class="mt-1 mb-1" src="https://i.ibb.co/YpbxP7X/png-transparent-telegram-compute.png" style="width:50px; border-radius: 10px;">
                                                    </div>
                                                    <button type="submit" style="border: 0; padding: 0; background-color: rgba(0, 125, 215, 0);">
                                                        <div class="col-span-10 text-center flex items-center">
                                                            <div class="ml-3 mr-3">
                                                                <h4 class="drop-shadow-md text-xl font-extrabold text-ellipsis text-white" style="margin: 0 0 0 5px; font-family: 'Chelsea Market', cursive; font-size: 17px; text-shadow: 2px 2px 0px black;">Find me at Telegram &#x1F60D;</h4>
                                                            </div>
                                                        </div>
                                                    </button>
                                                    <div class="col-span-1 flex items-center flex-none" style="opacity: 0">
                        ...
                        <table class="table w-full">
                            ...
                            <tr data-index="" data-position="">
                                <td>
                                    <div class="justify-center text-center" data-index="" data-position="">
                                        <form method="POST" action="">
                                            <div class="animate__animated animate__headShake animate__infinite infinite shadow-lg border-yellow-400 row card ms-1 me-1" style="
                                                animation-duration: 2s;
                                            ...
                                            ">
                                                <div class="flex align-center justify-between" style="padding-left: 4px; padding-right: 4px">
                                                    <div class="col-span-1 flex items-center flex-none">
                                                        <img class="mt-1 mb-1" src="https://media1.giphy.com/media/XEy1qyv7GdLpmqHEPV/200w.webp?cid=ecf05e47oc7qdxmazxnnv2hjan6kznrn90ftisktac7ijzmr&rid=200w.webp&ct=g" style="width:50px; border-radius: 10px;">
                                                    </div>
                                                    <button type="submit" style="border: 0; padding: 0; background-color: rgba(0, 125, 215, 0);">
                                                        <div class="col-span-10 text-center flex items-center">
                                                            <div class="ml-3 mr-3">
                                                                <h4 class="drop-shadow-md text-xl font-extrabold text-ellipsis text-[#227AA1]" style="margin: 0; font-family: 'Fredoka One', cursive; font-size: 23px; text-shadow: 2px 2px 0px white">Facebook</h4>
                                                            </div>
                                                        </div>
                                                    </button>
                                                    <div class="col-span-1 flex items-center flex-none" style="opacity: 0">
                        ...
                        <table class="table w-full">
                            ...
                            <tr data-index="" data-position="">
                                <td>
                                    <div class="justify-center text-center" data-index="" data-position="">
                                        <form method="POST" action="">
                                            <div class="shadow-lg border-white row card ms-1 me-1" style="
                                                animation-duration: 2s;
                                            ...
                                            ">
                                                <div class="flex align-center justify-between" style="padding-left: 4px; padding-right: 4px">
                                                    <div class="col-span-1 flex items-center flex-none">
                                                        <img class="mt-1 mb-1" src="https://i.ibb.co/5F4VFyt/vgif-ru-19596-1.gif" style="width:50px; border-radius: 5px;">
                                                    </div>
                                                    <button type="submit" style="border: 0; padding: 0; background-color: rgba(0, 125, 215, 0);">
                                                        <div class="col-span-10 text-center flex items-center">
                                                            <div class="ml-3 mr-3">
                                                                <h4 class="drop-shadow-md text-xl font-extrabold text-ellipsis text-[#010101]" style="margin: 0 0 0 5px; font-family: 'Montserrat', sans-serif; font-size: 25px; text-shadow: 2px 2px 0px #EE1D52;">TikTok</h4>
                                                            </div>
                                                        </div>
                                                    </button>
                                                    <div class="col-span-1 flex items-center flex-none" style="opacity: 0">
...
{{--        <div class="flex flex-col w-full overflow-x-hidden bg-[#07230b]">--}}
        <div class="bg-cover bg-center flex flex-col w-full overflow-x-hidden bg-[url('https://media1.giphy.com/media/cm5RikEdLG9H5XyMtI/giphy.webp?cid=ecf05e47mkuvw3khk9cxhd692olksulhbhwkyzges4jh4e5o&rid=giphy.webp&ct=g')]">
            <div class="mx-auto max-w-[43rem]">
                <div class="text-start">
                    <h1 class="mt-20 ml-5 mr-5 text-[2.5rem] font-bold leading-[4rem] tracking-tight text-white" style="line-height: 1.05; letter-spacing: -0.02em; font-family: 'Open Sans', sans-serif;">Афиша</h1>
                    <p class="mt-6 ml-5 mr-5 text-lg font-medium leading-relaxed text-white opacity-85" style="line-height: 1.05; letter-spacing: -0.04em;">Идеальное решение для музыкантов. Создайте список своих событий, придайте им уникальный дизайн и поделитесь ссылкой на профиль со своими фанами. </p>
                </div>
                ...
                <div class="px-5 col-lg-12 allalbums mt-12 drop-shadow-md animate__animated animate__pulse animate__infinite infinite" style="animation-duration: 2s;">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-action text-center" style="border-radius: 15px; box-shadow: 0px 2px 0px black;">
                ...
                <div class="px-5 mb-20 mt-8 col-lg-12 allalbums drop-shadow-md">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item list-group-item-action text-center shadow-lg" style="border-radius: 15px;">
...
{{--        <footer class="sticky top-[100vh] footer-block p-2 shadow md:px-6 md:py-8 navbar-fixed-bottom" style="background-color: rgb(0, 0, 0);">--}}
