        ...
        <form action="{{ route('profileFilterStatistic', ['user' => $user->id]) }}" method="GET">
            ...
            <div date-rangepicker class="flex items-center">
                <div class="relative">
                    ...
                    <input id="from" name="from" type="text" class="bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 @if($user->dayVsNight == 1) bg-gray-900 dark:text-white @endif dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{ __('main.user_stat_from') }}">
                </div>
                ...
                <div class="relative">
                    ...
                    <input id="to" name="to" type="text" class="bg-gray-50 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 @if($user->dayVsNight == 1) bg-gray-900 dark:text-white @endif dark:border-gray-600 dark:placeholder-gray-400 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="{{ __('main.user_stat_end') }}">
                </div>
            </div>
            <div class="mt-4">
