<x-app-layout :user="$user">
    ...
    <div class="m-5 flex justify-center drop-shadow-lg">
        @if(isset($user->qrCode->code))
            <a class="font-semibold text-gray-900 underline dark:text-indigo-600 decoration-indigo-600" href="{{ route('qrDownload', ['user' => $user->id]) }}">{{ __('main.qr_download') }}</a>
        @endif
    </div>
            ...
            <div class="mx-auto max-w-screen-xl sm:px-6 lg:px-8 mb-10">
                ...
                <form action="{{ route('uploadLogotype', ['user' => $user->id]) }}" method="post" enctype="multipart/form-data"> @csrf
                    <div class="mb-3 text-center">
                        <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_logo') }}</label>
                        ...
                        <p class="mt-1 text-sm @if($user->dayVsNight == 1) text-gray-500 @else text-gray-500 @endif" id="avatar">{{ __('main.qr_logo_descr') }}</p>
                    </div>
            ...
            <div class="mx-auto max-w-screen-xl sm:px-6 lg:px-8 mb-20">
                <form action="{{ route('generateQrCode', ['user' => $user->id]) }}" method="post" enctype="multipart/form-data"> @csrf
                    <div class="mb-6 text-center">
                        <label for="type" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_color_type') }}</label>
                        <select name="qr_type" id="type" style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                            <option selected value="colors">{{ __('main.qr_color_color') }}</option>
                            <option value="gradient">{{ __('main.qr_color_gradient') }}</option>
                        </select>
                    </div>
                    <div id="gradient">
                        <div class="mb-8 text-center">
                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_gradient_red_start') }}</label>
                        ...
                        <div class="mb-8 text-center">
                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_gradient_green_start') }}</label>
                        ...
                        <div class="mb-8 text-center">
                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_gradient_blue_start') }}</label>
                        ...
                        <div class="mb-8 text-center">
                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_gradient_red_end') }}</label>
                        ...
                        <div class="mb-8 text-center">
                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_gradient_green_end') }}</label>
                        ...
                        <div class="mb-8 text-center">
                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_gradient_blue_end') }}</label>
                        ...
                        <div class="mb-6 text-center">
                            <label for="type" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_gradient_type') }}</label>
                    ...
                    <div id="colors">
                        <div class="mb-3 text-center">
                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_bg_color') }}</label>
                        ...
                        <div class="mb-9 text-center">
                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_color') }}</label>
                            ...
                            <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
                                ...
                                <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                                    <div class="py-2 px-4 font-light border-gray-200 dark:border-gray-700">
                                        <div class="mb-3 text-center">
                                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_bg') }}</label>
                                        ...
                                        <div class="mb-8 text-center">
                                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_red') }}</label>
                                        ...
                                        <div class="mb-8 text-center">
                                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_green') }}</label>
                                        ...
                                        <div class="mb-8 text-center">
                                            <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_blue') }}</label>
                    ...
                    <div class="mb-6 text-center">
                        <label for="type" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_style') }}</label>
                        <select name="qr_style" id="type" style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                            <option selected value="square">{{ __('main.qr_square') }}</option>
                            <option value="round">{{ __('main.qr_round') }}</option>
                        </select>
                    </div>
                    @if(isset($user->qrCode->logotype))
                    <div class="mb-6 text-center">
                        <label for="steps-range" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">{{ __('main.qr_logo_size') }}</label>
