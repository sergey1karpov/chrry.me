    ...
    <body class="antialiased">
    	<div class="container-fluid justify-content-center text-center">
			...
			<div class="row">
				<a href="{{ route('userHomePage',  ['user' => Auth::user()->slug]) }}" style="text-decoration: none; border: 0; padding: 0">
                    ...
                    @if(isset($user->userSettings->logotype))
                        <div class="d-flex justify-content-center block1 box-part text-center @if($user->dayVsNight) bg-dark @endif" style="margin: 0; background-color: #f26868; border-radius: 0">
                    ...
                    @else
                        <div class="col-12">
                            <div class="block1 box-part text-center @if($user->dayVsNight) bg-dark @endif" style="margin: 0; background-color: #f26868; border-radius: 0">
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    ...
                                                    <div class="col-8 d-flex align-items-center" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" style="padding-left: 0">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12">
                                                                <h4 class="block1-text mb-3 text-start @if($user->dayVsNight) text-white-50 @endif" style="font-family: 'Rubik', sans-serif; color: white; font-size: 0.7rem">Управляйте своими заказами и клиентами</h4>
                                                            </div>
                                                            <div class="col-12 text-start">
                                                                @if(count($user->orders->where('order_status', \App\Models\Order::NEW_ORDER)) != 0)
                                                                    <h1 style="color: white; font-family: 'Inter', sans-serif; font-size: 0.8rem;" class="@if($user->dayVsNight) text-white-50 @endif">
				...
				<div class="col-12" style="padding-left: 7px; padding: 0">
					<div class="block1 row shadow @if($user->dayVsNight) bg-dark @endif" style="background-color: #f26868">
						...
						<div class="col-8 d-flex align-items-center">
                            <a href="{{ route('getStats', ['user' => $user->id]) }}" style="border: 0">
                                <div class="row">
                                    <div class="col-12">
			...
			<div class="row" style=" margin-top: 1px">
                <div class="col-12" style="padding-right: 7px; padding: 0">
					<div class="block1 box-part text-center shadow-sm @if($user->dayVsNight) bg-dark @endif" style="margin: 0; background-color: white; padding-top: 10px; padding-bottom: 10px; border-radius: 0">
