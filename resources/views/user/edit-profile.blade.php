            ...
            <div class="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
                <form>
                    <div class="mb-6 text-center">
                        ...
                        <input name="avatar" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400" aria-describedby="avatar" id="avatar" type="file">
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-300" id="avatar">PNG, JPG or GIF (MAX Size. 5mb).</p>
                    </div>
                    <div class="mb-6 text-center">
                        <label for="name" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">Name</label>
                        <input placeholder="{{$user->name}}" type="text" name="name" id="name" style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                    </div>
                    <div class="mb-6 text-center">
                        <label for="name_color" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">Name color</label>
                        <input placeholder="{{$user->name_color}}" type="color" name="name_color" id="name_color" class="h-11 mt-1 block w-full @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm" style="border-radius: 50%">
                    </div>
                    <div class="mb-6 text-center">
                        <label for="slug" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">Slug</label>
                        <input placeholder="{{$user->slug}}" type="text" name="slug" id="slug" style="border: none" class="mt-1 bg-gray-50 text-gray-900 text-sm rounded-lg block w-full p-2.5 @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm dark:placeholder-gray-400 ">
                    </div>
                    <div class="mb-6 text-center">
                    ...
                    <div class="mb-6 text-center">
                        <label for="description_color" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">Description color</label>
                        <input placeholder="{{$user->description_color}}" type="color" name="description_color" id="description_color" class="h-11 mt-1 block w-full @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm" style="border-radius: 50%">
                    </div>
                    @if($user->verify == 1)
                        <div class="mb-6 text-center">
                            <label for="verify_color" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">Verify icon color</label>
                            <input placeholder="{{$user->verify_color}}" type="color" name="verify_color" id="verify_color" class="h-11 mt-1 block w-full @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm" style="border-radius: 50%">
                        </div>
                    @endif
                    <div class="mb-6 text-center">
                        <label for="background_color" class="mt-1 text-sm font-medium leading-relaxed text-indigo-600">Background color</label>
                        <input placeholder="{{$user->background_color}}" type="color" name="background_color" id="background_color" class="h-11 mt-1 block w-full @if($user->dayVsNight == 1) bg-[#0f0f0f] dark:text-gray-400 @endif shadow-sm" style="border-radius: 50%">
                    </div>
                </form>
            </div>
        </div>
