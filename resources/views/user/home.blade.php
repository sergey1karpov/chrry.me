...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
	    ...
	    <!-- Ссылки -->
	    @foreach($links as $link)
	  		<div class="container mt-3" style="padding-left:8px; padding-right:8px" @if($link->type == 'POST') id="post{{$link->id}}" data-bs-toggle="modal" data-bs-target="#post-{{$link->id}}" @endif>
